...
| `mehmet` | **33** | 31–35 | 0,85 | Kart sarmalı — asgari ödeme, gecikme, KMH |
...
| `ahmet` | **83** | 80–85 | 0,81 | Emekli — düşük gelir, borçsuz, enflasyona yeniliyor |
| `merve` | **50** | 44–56 | 0,53 | Gün 25 — geçiş dönemi, kısmi veri |
...
| `yasemin` | **66** | 64–69 | 0,8 | Manuel giriş — bakiye yok, tek pencere, kullanıcı etiketli |
<!-- /OTOMATIK:golden-skorlar -->
